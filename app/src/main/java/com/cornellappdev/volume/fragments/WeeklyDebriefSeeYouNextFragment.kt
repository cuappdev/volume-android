...
import com.cornellappdev.volume.databinding.FragmentDebriefSeeYouBinding
...
class WeeklyDebriefSeeYouNextFragment(private val callback : () -> Unit) : Fragment() {

    private lateinit var prefUtils: PrefUtils
    private lateinit var disposables: CompositeDisposable
    private lateinit var graphQlUtil: GraphQlUtil
    private var _binding: FragmentDebriefSeeYouBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDebriefSeeYouBinding.inflate(inflater, container, false)
